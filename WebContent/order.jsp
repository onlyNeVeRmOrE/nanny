...
<body>
	...
	<div id="employerDiv"
		...
		<h3 id="employerPhone">手机号:</h3>
		<h3 id="employerMail">邮箱号:</h3>
		<h3 id="employerPlace">居住地点:</h3>
		<h3 id="birthday">婴儿出生日期:</h3>
	</div>
	
	<div id="nannyDiv"
		style="position: absolute; display: none; border: 1px solid silver; background: silver;">
		<h3 id="nannyName">姓名：</h3>
		<h3 id="nannyPhone">手机号:</h3>
		<h3 id="nannyMail">邮箱号:</h3>
		<h3 id="nannyPlace">居住地点:</h3>
		<h3 id="skill" >技能标签：</h3>
	</div>
</body>
</html>