...
<head>
    <meta charset="utf-8">
    <title>用户中心</title>
    <link rel="stylesheet" href="other/bootstrap-3.3.7/css/bootstrap.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="other/jquery-nav/css/default.css">
   	...
   	<div class="container">
                <div class="row">
                    <section>
                        ...
                        <div>
                            <form action="" method="post" id="basicform" name="basicform" class="form-horizontal" enctype="multipart/form-data" target="basic_iframe">
                                <div class="row">
                                    <fieldset class="col-sm-7">
                                        <div id="username" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="username" value="" placeholder="2-4位中文名" />
                                            </div>
                                        </div>
                                        ...
                                        <div id="IDnumber" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="IDnumber" value="" placeholder="18位有效身份证号" />
                                            </div>
                                        </div>
                                        ...
                                        <div id="phone" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="phone" value="" placeholder="11位有效手机号" />
                                            </div>
                                        </div>

                                        <div id="appellation" class="form-group">
                                            <label class="col-sm-3 control-label">
                                        ...
                                        <div id="city" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="city" value="" placeholder="如：北京" />
                                            </div>
                                        </div>
                                        ...
                                        <div id="residence" class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="residence" value="" placeholder="如：xx省xx市xx县xx路" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-10 col-sm-offset-2">
                                            <input type="submit" id="basicsubmit" class="btn btn-default" value="提 交" onclick="basic();">
                                        </div>
                                    </div>
                                </div>
                            </form>
