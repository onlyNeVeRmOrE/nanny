	...
	<div id="wrapper" class="wrapper"></div>
		...
		<div class="container">
            <div class="row">
                <section>
                    ...
                    <div>
                        <form action="" method="post" id="employerform" name="employerform" class="form-horizontal" target="employer_iframe">
                            <fieldset>
                                <legend>月嫂要求</legend>

                                <div id="workPlace" class="form-group">
                                    <label class="col-sm-2 control-label">
                                        <p style='font-size:19px;font-weight:bold;'>需要工作住址</p>
                                    </label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="workPlace" placeholder="如：xx省xx市xx县xx路" />
                                    </div>
                                </div>
                                ...
                                <div id="isNeedLive" class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="radio">
                                            <label>  
                                                <input type="radio" name="isNeedLive" value="yes" required data-fv-notempty-message="请选择是否住家" /> 是		                              
                                            </label>
                                        </div>

                                        <div class="radio">
                                            <label>           
                                                <input type="radio" name="isNeedLive" value="no" /> 否         	                               
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div id="experience" class="form-group col-sm-4">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <option value="twoYear">2以上</option>
                                            <option value="fiveYear">5年以上</option>
                                        </select>
                                        </div>
                                    </div>

                                    <div id="employerEducation" class="form-group col-sm-4">
                                        <label class="col-sm-6 control-label">          
                                            <p style='font-size:19px;font-weight:bold;'>学历</p>     
                                        </label>
                                        <div class="col-sm-6">
                                            <select class="form-control" name="employerEducation">
                                            <option value="">请选择</option>
                                ...
                                <div class="row">
                                    <div id="employerSalary" class="form-group col-sm-4">
                                        <label class="col-sm-6 control-label">
                                            <p style='font-size:19px;font-weight:bold;'>可支付工资</p>
                                        </label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="employerSalary" placeholder="单位:元/月" />
                                        </div>
                                    </div>

                                    <div id="employerRestTime" class="form-group col-sm-4">
                                        <label class="col-sm-6 control-label">
                                            <p style='font-size:19px;font-weight:bold;'>月嫂可休息天数</p>
                                        </label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="employerRestTime" placeholder="单位:天/月" />
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset>
                                <legend>母婴情况</legend>
                                <div id="babyBirthday" class="form-group">
                                    <label class="col-sm-2 control-label">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row no-gutter">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" name="date" placeholder="日" />
                                            </div>
                                        </div>
                                ...
                                <div id="babyBirthWeight" class="form-group col-sm-4">
                                    <label class="col-sm-6 control-label">
                                        <p style='font-size:19px;font-weight:bold;'>婴儿出生体重</p>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="babyBirthWeight" placeholder="单位:千克" />
                                    </div>
                                </div>

                                <div id="motherAge" class="form-group col-sm-4">
                                    <label class="col-sm-6 control-label">
                                        <p style='font-size:19px;font-weight:bold;'>母亲年龄</p>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="motherAge" placeholder="单位:岁" />
                                    </div>
                                </div>

                                <div id="motherWeight" class="form-group col-sm-4">
                                    <label class="col-sm-6 control-label">
                                        <p style='font-size:19px;font-weight:bold;'>母亲体重</p>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="motherWeight" placeholder="单位:千克" />
                                    </div>
                                </div>

                                <div id="motherHeight" class="form-group col-sm-4">
                                    <label class="col-sm-6 control-label">
                                        <p style='font-size:19px;font-weight:bold;'>母亲身高</p>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="motherHeight" placeholder="单位:厘米" />
                                    </div>
                                </div>

                                <div id="deliveryTimes" class="form-group col-sm-4">
                                    <label class="col-sm-6 control-label">
                                        <p style='font-size:19px;font-weight:bold;'>分娩次数</p>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" name="deliveryTimes" placeholder="单位:次" />
                                    </div>
                                </div>

                                <div id="deliveryMode" class="form-group col-sm-4">
                                    <label class="col-sm-6 control-label">          
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="deliveryMode">
                                            <option value="">请选择</option>
                                            <option value="natural">顺产</option>
                            ...
                            <fieldset>
                                ...
                                <div id="healthReprotFile" class="form-group">
                                    <label class="col-sm-2 control-label">
                                        <p style='font-size:19px;font-weight:bold;'>母婴健康报告 &nbsp&nbsp&nbsp&nbsp(本站承诺保密)</p>
                                    </label>
                                    <div class="col-sm-4">
                                        <input type="file" class="form-control" name="healthReprotFile" />
                                        <span class="help-block">请上传pdf文件且大小不能超过10M</span>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-sm-10 col-sm-offset-2">      
                                    <input type="submit" id="employersubmit" class="btn btn-default" value="提 交" onclick="employer();">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                }).on('keyup', 'input[name="date"], input[name="month"], input[name="year"]', 'success.form.fv', function(e) {
